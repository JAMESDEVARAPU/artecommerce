...
import type { Product, Testimonial, GalleryItem } from "@shared/schema";

import heroImage from "@assets/generated_images/artist_workspace_hero_image.png";
import ceramicImage from "@assets/generated_images/handmade_ceramic_product.png";
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        ...
        <p className="text-white/90 text-lg md:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
          Discover unique handmade art, home décor, and personalized gifts. 
          Join our creative community through art classes and workshops.
        </p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <Link href="/classes">
            <Button
              size="lg"
              variant="outline"
              className="backdrop-blur-sm bg-white/10 border-white/30 text-white font-accent text-base px-8"
...
function CategoryShowcase() {
  const categories = [
    ...
    },
    {
      title: "Art Classes",
      description:
        "Unlock your creative potential with our structured art classes designed for all ages and skill levels. Learn techniques from a passionate educator.",
      image: classImage,
      link: "/classes",
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link href="/classes">
            <Button
              ...
              data-testid="button-cta-classes"
            >
              Browse Classes
            </Button>
          </Link>
